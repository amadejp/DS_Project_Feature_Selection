...
def compute_similarity(scores1,
    ...
    :param feature_names: list of feature names; if None, the indices of the features are used
    ...
    fimp1 = Fimp.create_fimp_from_relevances(scores1, feature_names)
    fimp2 = Fimp.create_fimp_from_relevances(scores2, feature_names)
